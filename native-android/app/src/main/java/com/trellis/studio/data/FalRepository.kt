...
class FalRepository(
    ...
    /** Resolves the current texture_size setting — must be one of SettingsRepository.FAL_TEXTURE_SIZES. */
    private val textureSizeProvider: () -> Int = { 1024 }
) : Model3DRepository {
    ...
    override suspend fun generateModel(
        ...
        val submitBody = JSONObject()
            ...
            .put("texture_size", textureSizeProvider())
            .toString()
